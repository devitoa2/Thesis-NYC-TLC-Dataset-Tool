...
@PageTitle("NYC TLC Yellow Taxi Trip Data")
public class YellowTripView extends VerticalLayout { 
	//Create a new grid of Yellow Trips (aggregate trips)
    Grid<YTripStats> grid = new Grid<>(YTripStats.class); 
    ...
    public YellowTripView(TripService service) {
    ...
    private void configureGrid() {
        grid.addClassNames("yellowtrips-grid");
        grid.setSizeFull();
