...
@Route(value="fhv", layout = MainLayout.class)
@PageTitle("NYC TLC For-Hire Vehicle Taxi Trip Data")
public class FHVTripView extends VerticalLayout { 
	//Create a new grid of Yellow Trips (aggregate trips)
    Grid<FHVTripStats> grid = new Grid<>(FHVTripStats.class); 
    ...
    public FHVTripView(TripService service) {
    ...
    private void configureGrid() {
        grid.addClassNames("fhvtrips-grid");
        grid.setSizeFull();
        grid.setColumns("zone", "locationID", "total_trips");
