...
public class YTripStats {
	...
	public YTripStats(long taxi_zone, String pLocationID, long total_trips, double trip_distance, double fare_amount, double total_amount) {
		zone = taxi_zone;
